    ...
    <ion-content :fullscreen="true">
      ...
      <ion-list>
        <ion-item
          ...
          @click="
            $router.push(
              getRoutePathByName($router, RouteNames.INFO_DETAIL_PAGE)?.replace(
                ':id',
...
import { getInfoKeys } from "@/utils/api";
...
const refreshList = async () => {
  itemKeys.value = await getInfoKeys();
};
